...
import { IArchiveDto, IOpenTokSessionDto } from '../../models';
import { HubConnectionService, OpenTokService } from '../../services';
...
export class VideoConsultationComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  private readonly _openTokSessionDto: IOpenTokSessionDto | null | undefined;
  userId: number = 0;
  ...
  inviteUsersComponentRef!: MatDialogRef<InviteUsersComponent> | null | undefined;

  constructor(
    @Optional() @Inject(MAT_DIALOG_DATA) private readonly _inputData: IOpenTokSessionDto | null | undefined,
    private readonly _matDialog: MatDialog,
    private readonly _dialogRef: MatDialogRef<VideoConsultationComponent>,
    ...
    this._openTokSessionDto = this._inputData;
    this.userId = Number(this._openTokSessionDto?.userId || '0');
  }
  ...
  ngOnDestroy(): void {
    ...
    this.inviteUsersComponentRef?.close();
    this.inviteUsersComponentRef = null;
  ...
  onInviteUser(): void {
    ...
    this.inviteUsersComponentRef = this._matDialog.open(InviteUsersComponent, {
      height: '300px',
      width: '600px',
      maxWidth: 'calc(100vw - 50px)',
      maxHeight: 'calc(100vh - 150px)',
    ...
    this.subSink.sink = this.inviteUsersComponentRef
      .afterClosed()
      .subscribe(() => {
        this.inviteUsersComponentRef = null;
      });
